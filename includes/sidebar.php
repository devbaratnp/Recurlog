...
<aside class="sidebar<?= $collapsed ? ' collapsed' : '' ?>" id="sidebar" tabindex="-1">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="service-add.php" class="sidebar-nav-link <?= isActive('service-add.php') ?>"><i data-lucide="wrench"></i><span>Order For</span></a>
    ...
    <a href="customer-report.php" class="sidebar-nav-link <?= isActive('customer-report.php') ?>"><i data-lucide="file-text"></i><span>Customer Report</span></a>
    <a href="reports.php" class="sidebar-nav-link <?= isActive('reports.php') ?>"><i data-lucide="bar-chart-3"></i><span>Reports</span></a>
    ...
    <a href="settings.php" class="sidebar-nav-link <?= isActive('settings.php') ?>"><i data-lucide="settings"></i><span>Settings</span></a>
  </nav>
...
<nav class="bottom-nav md:hidden">
  ...
  <a href="tasks.php" class="flex flex-col items-center justify-center gap-0.5 px-2 py-1 rounded-lg min-w-0 flex-1 <?= isActive('tasks.php') ? 'active' : 'text-gray-500' ?>"><i data-lucide="calendar" class="w-5 h-5"></i><span class="text-[10px] font-medium truncate w-full text-center">Tasks</span></a>
