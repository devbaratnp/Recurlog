...
--
-- Host: localhost:3306
-- Generation Time: Jun 05, 2026 at 02:20 PM
...
-- Procedures
--
CREATE DEFINER=`cpses_ekn86pb25p`@`localhost` PROCEDURE `TruncateAllTables` ()   BEGIN
...
(9, 'Devbarat', 'Bahudramai-07, Phulkaul, Parsa', 'Mahabirsthan', '+9779811144402', '', 27.0000000, 84.8700000, '2026-06-04 15:11:42', '2026-06-05 10:13:59');
...
(29, 'New recurring task \"AC - Birgunj Sweets\" added for Birgunj Sweets', 'service', 72, 1, '2026-06-05 11:21:44');
...
--
-- Dumping data for table `fscrm_services`
--
...
(72, 8, NULL, 'AC', 'AC - Birgunj Sweets', 'then want to clean the room', 1, '2026-06-05', 1, '0', 1, 'weeks', 'last-done', '2026-06-05 11:21:44', '2026-06-05 11:21:44');
...
(168, 72, 8, 'AC - Birgunj Sweets', 'pending', '2026-06-05', NULL, 1, '', NULL, NULL, NULL, NULL, NULL, '2026-06-05 11:21:44', '2026-06-05 11:21:44');
...
(2, 'Ramesh Yadav', 'ramesh@demo.com', '$2y$12$QKRRQnnSRkak5wPaPRzC9OKB6.kCqqwEhmZVapSiwEL2EipEgJTNa', 'staff', 1, NULL, '2026-06-04 15:19:22'),
(3, 'Suresh Thakur', 'suresh@demo.com', '$2y$12$QKRRQnnSRkak5wPaPRzC9OKB6.kCqqwEhmZVapSiwEL2EipEgJTNa', 'staff', 2, NULL, '2026-06-04 15:19:22'),
(4, 'Bikash Sah', 'bikash@demo.com', '$2y$12$QKRRQnnSRkak5wPaPRzC9OKB6.kCqqwEhmZVapSiwEL2EipEgJTNa', 'staff', 3, NULL, '2026-06-04 15:19:22'),
(5, 'Anita Devi', 'anita@demo.com', '$2y$12$QKRRQnnSRkak5wPaPRzC9OKB6.kCqqwEhmZVapSiwEL2EipEgJTNa', 'staff', 4, NULL, '2026-06-04 15:19:22'),
(6, 'Manoj Kumar', 'manoj@demo.com', '$2y$12$QKRRQnnSRkak5wPaPRzC9OKB6.kCqqwEhmZVapSiwEL2EipEgJTNa', 'staff', 5, NULL, '2026-06-04 15:19:22');
